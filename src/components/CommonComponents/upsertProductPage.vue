...
export default {
  ...
  setup() {
    ...
    const mainPic = computed(() => {
      imgUrl.value=productObj.value.productPic===''?defaultPicUrl.value:productObj.value.productPic;
      return imgUrl.value;
    });
    ...
    const noImageButton = function () {
      ...
      imgUrl.value=defaultPicUrl.value;
    }
    const editImageButton= function () {
      imgUrl.value===''?defaultPicUrl.value:imgUrl.value
