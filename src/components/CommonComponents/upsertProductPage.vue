    ...
    <div style="background-color: white" class=" col-12 mt-3 pt-3 mb-3 pb-3 justify-content-md-center">
      <div class="row ">
        ...
        <b-col class="col-md-6">
          <!--                pic start-->
          <div class="form-group">
              <img class="output ml-5" :src="imgUrl" style="border:lightgray;border-style: solid;width:65%">
              <label class="ml-2">
                <div>
                <b-button variant="outline-info" class="mb-2" size="sm" pill>
      ...
      <div class="row justify-content-md-center">
        <div class="col-3">
          ...
          <div class="mr-5 ml-2 mt-2">
            <b-button v-for="(btn, idx) in sizeArray" :key="idx" clLass="item mt-2 ml-2" :variant="btn.variant"
